...
host          = str("redis-16275.c292.ap-southeast-1-1.ec2.cloud.redislabs.com")
port          = int(16275)
db            = int(0)
password      = "MmZKhfFQ5PDziHU7Bk8Y7FTQUHlW3vs3"
key_prefix    = str("trading:")
ttl_seconds   = int(604800)  # 7 ngày

store = RedisStateStore(host, port, db, password, key_prefix, ttl_seconds)
print(store.items())